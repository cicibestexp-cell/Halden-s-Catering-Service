...
-- ==========================================
-- Procurement Hub - Suppliers and Recipes
-- ==========================================
...
('MeatMasters Inc.', 'meatmasters@example.com'),
('Green Valley', 'sales@greenvalley.com'),
('General Wholesale', 'info@gwholesale.com'),
('Poultry Palace', 'poultry@example.com'),
('Market', 'Local Public Market');

-- Seed Recipe Ingredients
INSERT INTO public.recipe_ingredients (dish_name, ingredient_name, qty20, unit, supplier_id) VALUES
('Pork Belly Lechon', 'Whole Pork Belly', 5, 'kg', (SELECT id FROM public.suppliers WHERE name = 'MeatMasters Inc.')),
('Pork Belly Lechon', 'Lemongrass & Spices', 0.5, 'kg', (SELECT id FROM public.suppliers WHERE name = 'Green Valley')),
('Pork Belly Lechon', 'Charcoal / Firewood', 1, 'sack', NULL),
('Beef Caldereta', 'Beef Brisket Chunks', 4, 'kg', (SELECT id FROM public.suppliers WHERE name = 'MeatMasters Inc.')),
('Beef Caldereta', 'Tomato Sauce & Liver Spread', 2, 'kg', (SELECT id FROM public.suppliers WHERE name = 'General Wholesale')),
('Beef Caldereta', 'Mixed Vegetables', 2, 'kg', (SELECT id FROM public.suppliers WHERE name = 'Green Valley')),
('Garlic Butter Chicken', 'Whole Chicken Parts', 5, 'kg', (SELECT id FROM public.suppliers WHERE name = 'Poultry Palace')),
('Garlic Butter Chicken', 'Unsalted Butter', 1, 'kg', (SELECT id FROM public.suppliers WHERE name = 'General Wholesale')),
('Garlic Butter Chicken', 'Garlic & Herbs', 0.5, 'kg', NULL),
('Pork Sinigang', 'Pork Belly', 4, 'kg', (SELECT id FROM public.suppliers WHERE name = 'MeatMasters Inc.')),
('Pork Sinigang', 'Sinigang Veggies', 2, 'kg', (SELECT id FROM public.suppliers WHERE name = 'Green Valley'));

-- RLS Policies
ALTER TABLE public.suppliers ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.recipe_ingredients ENABLE ROW LEVEL SECURITY;

CREATE POLICY ""allow_all"" ON public.suppliers FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY ""allow_all"" ON public.recipe_ingredients FOR ALL TO authenticated USING (true) WITH CHECK (true);
